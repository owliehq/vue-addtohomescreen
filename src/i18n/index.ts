...
2. Drag and drop the (i) button left of your navigation bar to your desktop`,
      ...
      others:
        "Looks like your browser doesn't support add to homescreen natively. Feel free to update/change your browser.",
    },
  },
  fr_FR: {
...
2. Cliquez & glissez l'icône (i) présent à gauche de votre barre de navigation sur votre bureau`,
      ...
      others:
        "Il semblerait que votre navigateur ne supporte pas la fonctionnalité d'ajout à la page d'accueil. Mettez-le à jour ou changez de navigateur.",
    },
  },
  ru_RU: {
...
2. Перетащите кнопку (i) слева от панели навигации на рабочий стол.`,
      ...
      others:
        'Похоже, Ваш браузер изначально не поддерживает добавление на рабочий стол. Попробуйте обновить/изменить свой браузер.',
    },
  },
  de_DE: {
...
2. Ziehen Sie die (i)-Schaltfläche links von der Navigationsleiste auf Ihren Desktop`,
  ...
  2. Arrastra y suelta el botón (i) a la izquierda de tu barra de navegación a tu escritorio`,
      ...
      others:
        'Parece que tu navegador no admite la función de añadir a la pantalla de inicio de forma nativa. Siéntete libre de actualizar o cambiar tu navegador.',
    },
  },
  pt_PT: {
  ...
  2. Arraste e solte o botão (i) à esquerda da barra de navegação para a área de trabalho`,
      ...
      others:
        'Parece que seu navegador não suporta adicionar à tela inicial de forma nativa. Sinta-se à vontade para atualizar ou alterar o navegador.',
    },
  },
  nl_NL: {
  ...
  2. Sleep het (i)-pictogram links van uw navigatiebalk naar uw bureaublad`,
      ...
      others:
        'Het lijkt erop dat uw browser niet native de functie "Toevoegen aan startscherm" ondersteunt. Voel je vrij om je browser bij te werken of te veranderen.',
    }
  },
  pl_PL: {
  ...
  2. Przeciągnij i upuść przycisk (i) po lewej stronie paska nawigacji na pulpit`,
      ...
      others:
        'Wygląda na to, że Twoja przeglądarka nie obsługuje natywnie dodawania do ekranu głównego. Śmiało zaktualizuj lub zmień przeglądarkę.',
    }
  },
  ja_JP: {
  ...
  2. ナビゲーションバーの左側にある (i) ボタンをデスクトップにドラッグ＆ドロップする`,
      ...
      others:
        'お使いのブラウザはホーム画面に追加をネイティブにサポートしていないようです。ブラウザを更新/変更してください。',
    },
  },
  zh_CN: {
